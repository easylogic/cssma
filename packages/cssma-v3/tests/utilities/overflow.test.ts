...
describe('parseUtility (overflow)', () => {
  describe('overflow', () => {
    it('should parse Tailwind v4 overflow classes', () => {
      ...
      expect(parseUtility('overflow-[inherit]')).toEqual(baseUtility({ prefix: 'overflow', value: 'inherit', arbitrary: true, arbitraryValue: 'inherit', raw: 'overflow-[inherit]' }));
  ...
  describe('overflow-x', () => {
    it('should parse Tailwind v4 overflow-x classes', () => {
      ...
      expect(parseUtility('overflow-x-[inherit]')).toEqual(baseUtility({ prefix: 'overflow-x', value: 'inherit', arbitrary: true, arbitraryValue: 'inherit', raw: 'overflow-x-[inherit]' }));
  ...
  describe('overflow-y', () => {
    it('should parse Tailwind v4 overflow-y classes', () => {
      ...
      expect(parseUtility('overflow-y-[inherit]')).toEqual(baseUtility({ prefix: 'overflow-y', value: 'inherit', arbitrary: true, arbitraryValue: 'inherit', raw: 'overflow-y-[inherit]' }));
