...
import { figmaToTailwind } from '../src/figmaToTailwind';
...
describe('figmaToTailwind', () => {
  describe('Layout', () => {
    it('should convert layout mode', () => {
      expectClassesEqual(figmaToTailwind({ layoutMode: 'HORIZONTAL' }), 'flex-row');
      expectClassesEqual(figmaToTailwind({ layoutMode: 'VERTICAL' }), 'flex-col');
    });

    it('should convert sizing', () => {
      expectClassesEqual(figmaToTailwind({ 
  ...
  describe('Typography', () => {
    it('should convert font size', () => {
      expectClassesEqual(figmaToTailwind({ fontSize: 20 }), 'text-xl');
      expectClassesEqual(figmaToTailwind({ fontSize: 15 }), 'text-[15]');
    });
  ...
  describe('Effects', () => {
    ...
    it('should convert opacity', () => {
      expectClassesEqual(figmaToTailwind({ opacity: 0.5 }), 'opacity-[0.5]');
    });
  });

  describe('Geometry', () => {
    it('should convert border radius', () => {
      expectClassesEqual(figmaToTailwind({ cornerRadius: 8 }), 'rounded-lg');
      expectClassesEqual(figmaToTailwind({ cornerRadius: 9999 }), 'rounded-full');
      expectClassesEqual(figmaToTailwind({ cornerRadius: 10 }), 'rounded-[10]');
    });
  });
  ...
  describe('Combined Properties', () => {
    it('should convert multiple properties', () => {
      ...
      expectClassesEqual(figmaToTailwind(styles),
